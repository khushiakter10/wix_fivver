  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(  'My Chats',   style: TextFontStyle.headline24c1E293Bpoppinsw700)),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    chatNames[index],
                                    style: TextFontStyle.headline16c1E293Bpoppinsw500,
                                  ),
                                 UIHelper.verticalSpace(4.h),
                                  Text(
                                    chatMessages[index],
                                    style: TextFontStyle.headline16c475569poppinsw500.copyWith(fontSize: 14.sp),
                                    maxLines: 1,
                              ...
                              children: [
                                ...
                                if (unreadCounts[index] > 0)
                                  Container(
                                    ...
                                    child: Text(
                                      unreadCounts[index] > 99 ? '99+' : unreadCounts[index].toString(),
                                      style: TextFontStyle.headline24cFFFFFFpoppinsw600.copyWith(fontSize: 12.sp),
                                    ),
                                  ),
                              ],
                            ),
